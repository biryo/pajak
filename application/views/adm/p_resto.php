<div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Data Pajak Resto</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                    ...
                    <div class="panel panel-success">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="container">
                                ...
                                <form method="post" id="import_form_resto" enctype="multipart/form-data">
                            ...
                            <table width="100%" class="table table-striped table-bordered dark" id="dataTables-example" style="color: black;">
                                ...
                                <tbody >
                                           <?php
                                              ...
                                              <tr>
                                                <td><?php echo $no++; ?></td>
                                                <td><?php echo $t->no_pdr ?></td>
                                                <td><?php echo $t->nama ?></td>
                                                <td><?php echo $t->alamat_pdr ?></td>
                                                <?php 
                                                    if ($t->stts == 'Himbauan') {
                                                ...
                                                <td nowrap="nowrap" class="text-center">
                                                  ...
                                                  <a class="btn btn-primary btn-xs" title="Edit" href="<?php echo base_url().'adm/c_adm/edit_presto/'.$t->id_pr; ?>"><span class="glyphicon glyphicon-edit" data-toggle="modal" data-target="#Edit"></span></a>
                                                  <a class="btn btn-warning btn-xs" title="Hapus" href="<?php echo base_url().'adm/c_adm/apus_presto/'.$t->id_pr; ?>"><span class="glyphicon glyphicon-remove"></span></a> 
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="<?php echo base_url().'adm/c_adm/plus_presto' ?>" class="form-contact" method="post">     

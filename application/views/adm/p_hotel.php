<div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Data Pajak Hotel</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                    ...
                    <div class="panel panel-success">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="container">
                                ...
                                <form method="post" id="import_form_hotel" enctype="multipart/form-data">
                            ...
                            <table width="100%" class="table table-striped table-bordered dark" id="dataTables-example" style="color: black;">
                                <thead>
                                    <tr>
                                        <th>No</th>
                                        <th>NOPD</th>
                                ...
                                <tbody >
                                           <?php
                                              $no = 1;
                                              foreach ($p_hotel as $t) {
                                              ?>
                                              <tr>
                                                <td><?php echo $no++; ?></td>
                                                <td><?php echo $t->no_pdh ?></td>
                                                <td><?php echo $t->nama ?></td>
                                                <td><?php echo $t->alamat_pdh ?></td>
                                                <?php 
                                                    if ($t->stts == 'Himbauan') {
                                                ...
                                                <td nowrap="nowrap" class="text-center">
                                                  ...
                                                  <a class="btn btn-primary btn-xs" title="Edit" href="<?php echo base_url().'adm/c_adm/edit_photel/'.$t->id_ph; ?>"><span class="glyphicon glyphicon-edit" data-toggle="modal" data-target="#Edit"></span></a>
                                                  <a class="btn btn-warning btn-xs" title="Hapus" href="<?php echo base_url().'adm/c_adm/apus_photel/'.$t->id_ph; ?>"><span class="glyphicon glyphicon-remove"></span></a>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="<?php echo base_url().'adm/c_adm/plus_photel' ?>" class="form-contact" method="post">     

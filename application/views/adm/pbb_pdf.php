...
<table class="table-data">
	<thead>
		...
		<tr>
			...
			<td width="1%">:</td>	
			<td width="73%"><b><?php echo $t->nm_wp_sppt; ?></b></td>
		</tr>
		<tr>
			<td></td>
			<td></td>
			...
			<td>Alamat WP</td>
			<td>:</td>
			<td><b><?php echo $t->alamat_op; ?></b></td>
		</tr>
		<tr>
			<td></td>
			<td></td>
...
1. Berdasarkan catatan administrasi pada Sistem Informasi Manajemen PBB-P2 pada 
   ...
   Pajak Bumi dan Bangunan atas SPPT PBB-P2 sebagai berikut:
	...
	Nama Wajib Pajak 	: <b><?php echo $t->nm_wp_sppt; ?></b>
	Nomor Objek Pajak (NOP)	: <b><?php echo $t->nop_gabung; ?></b>
	Alamat Objek Pajak 	: <b><?php echo $t->alamat_op; ?></b>

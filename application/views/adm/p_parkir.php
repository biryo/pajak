<div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Data Pajak Parkir</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                    ...
                    <div class="panel panel-success">
                        ...
                        <div class="panel-body">
                            <div class="container">
                                ...
                                <form method="post" id="import_form_parkir" enctype="multipart/form-data">
                            ...
                            <table width="100%" class="table table-striped table-bordered dark" id="example" style="color: black;">
                                ...
                                <tbody >
                                           <?php
                                              $no = 1;
                                              foreach ($p_parkir as $t) {
                                              ?>
                                              <tr> 
                                                <td><?php echo $no++; ?></td>
                                                <td><?php echo $t->no_pdp ?></td>
                                                <td><?php echo $t->nama ?></td>
                                                <td><?php echo $t->alamat_pdp ?></td>
                                                <?php 
                                                    if ($t->stts == 'Himbauan') {
                                                ...
                                                <td nowrap="nowrap" class="text-center">
                                                  ...
                                                  <a class="btn btn-primary btn-xs" title="Edit" href="<?php echo base_url().'adm/c_adm/edit_pparkir/'.$t->id_pp; ?>"><span class="glyphicon glyphicon-edit" data-toggle="modal" data-target="#Edit"></span></a>
                                                  <a class="btn btn-warning btn-xs" title="Hapus" href="<?php echo base_url().'adm/c_adm/apus_pparkir/'.$t->id_pp; ?>"><span class="glyphicon glyphicon-remove"></span></a>
                                                  <a class="btn btn-success btn-xs" title="Hapus" href="<?php echo base_url().'adm/c_adm/apus_pbb/'.$t->id_pp; ?>"><span class="glyphicon glyphicon-print"></span></a>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="<?php echo base_url().'adm/c_adm/plus_pparkir' ?>" class="form-contact" method="post">     

                ...
                <div class="col-lg-12">
                    <div class="panel panel-success">
                        ...
                        <div class="panel-body">                            
                                                <?php foreach ($p_hiburan as $t){ }?>
                                                <form action="<?php echo base_url().'adm/c_adm/edit_phiburan_aksi/'.$t->id_phb; ?>" class="form-contact" method="post">
                                                        <input type="hidden" name="id_phb" value="<?php echo $t->id_phb; ?>" required>
                                                  <div class="row">

                                                    <div class="col-lg-5">
                                                      <div class="form-group">
                                                          <label>NOPD</label>
                                                          <input type="text" name="nopd" class="form-control"  placeholder="" value="<?php echo $t->no_pdhb; ?>" required oninvalid="this.setCustomValidity('Form Tidak Boleh Kosong')" oninput="setCustomValidity('')">
                                                      </div>
                                                      ...
                                                      <div class="form-group">
                                                          <label>Alamat</label>
                                                          <input type="text" name="alamat" class="form-control"  placeholder="" value="<?php echo $t->alamat_pdhb; ?>" required oninvalid="this.setCustomValidity('Form Tidak Boleh Kosong')" oninput="setCustomValidity('')">
                                                      </div>
